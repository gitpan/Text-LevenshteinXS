...
XSUBPPDIR = /opt/local/lib/perl5/5.8.8/ExtUtils
XSUBPP = $(XSUBPPDIR)$(DFSEP)xsubpp
XSUBPPRUN = $(PERLRUN) $(XSUBPP)
XSPROTOARG = 
XSUBPPDEPS = /opt/local/lib/perl5/5.8.8/ExtUtils/typemap $(XSUBPP)
XSUBPPARGS = -typemap /opt/local/lib/perl5/5.8.8/ExtUtils/typemap
XSUBPP_EXTRA_ARGS = 
...
CCFLAGS = -I/opt/local/include -fno-common -DPERL_DARWIN -no-cpp-precomp -fno-strict-aliasing -pipe -Wdeclaration-after-statement -I/usr/local/include -I/opt/local/include
OPTIMIZE = -O3
PERLTYPE = 
MPOLLUTE = 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  core.[0-9][0-9][0-9][0-9][0-9] LevenshteinXS.c \
	  *perl.core core.*perl.*.? \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version_from: LevenshteinXS.pm' >> META_new.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '    Test:                          ' >> META_new.yml
